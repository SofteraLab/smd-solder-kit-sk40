...
SMD Solder Kit — навчальна плата для практики пайки від Softera Lab. Плата вчить паяти SMD і показує результат: ланцюг світлодіодів загоряється, коли секція зібрана правильно.

Мікроконтролера на платі немає, тому прошивка не потрібна. Такт дає таймер на місці U1. Дві мікросхеми логічних лічильників на місцях U2 і U3 по черзі вмикають світлодіоди.
...
| U1 | Таймер, SOIC-8 (4+4) | Задає такт. Мікроконтролером не є |
| U2, U3 | Лічильник, SOIC-16 (8+8) | Дві однакові мікросхеми, крокують по LED |
...
Файли плати із Cad, Gerber і PDF цієї ревізії може знаходитись у [`hardware/`](../hardware/). Номінали з BOM дописуються у таблицю характеристик, коли схема з’явиться поруч із картками.
